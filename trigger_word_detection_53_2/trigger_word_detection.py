...
10000
  (used by the pydub module to synthesize audio)
1375=Ty
  (the number of steps in the output of the GRU you'll build).
'''
...
def is_overlapping(segment_time, previous_segments):
    ...
    for previous_start, previous_end in previous_segments:
        if previous_start <= segment_time[1] and previous_end >= segment_time[0]:
            overlap = True
    ### END CODE HERE ###
