...
def model(X, Y, layers_dims, optimizer, learning_rate = 0.0007, mini_batch_size = 64, beta = 0.9,
    ...
    seed = 10  # For grading purposes, so that your "random" minibatche
    ...
    for i in range(num_epochs):
        ...
        for batch in mini_batches:
            ...
            if optimizer == "gd":
                ...
                t = t + 1
                parameters, v, s = update_parameters_with_adam1(parameters, gradients, v, s, t, learning_rate, beta1, beta2, epsilon)
